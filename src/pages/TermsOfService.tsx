  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-12">
      ...
      <div className="prose prose-yellow">
        ...
        <p>
          KundaPay est une entreprise fondée par Anouchka MINKOUE OBAME et STORMY STEPHEN NDEMBET NASCIMENTO.<br />
        ...
        <ul>
          <li>
            <strong>Stripe</strong> : Notre partenaire principal pour les paiements par carte bancaire et les virements internationaux.
            Certifié PCI Service Provider Level 1, Stripe garantit :
            <ul>
              <li>Le cryptage SSL 256 bits pour toutes les transactions</li>
              <li>La protection contre la fraude grâce à des systèmes de détection avancés</li>
              <li>La conformité aux normes internationales de sécurité des paiements</li>
              <li>Le traitement sécurisé des données de carte bancaire</li>
            </ul>
          </li>
          <li>
            <strong>Airtel Money</strong> : Pour les transferts d'argent mobile au Gabon
          </li>
          <li>
        ...
        <ol>
          ...
          <li>Validation et paiement sécurisé via nos partenaires (Stripe, Airtel Money, etc.)</li>
        ...
        <p className="mt-8 text-sm text-gray-600">
          Pour plus d'informations sur la sécurité des paiements, vous pouvez consulter :
        </p>
        <ul className="text-sm text-gray-600">
          <li>
            <a href="https://stripe.com/docs/security" target="_blank" rel="noopener noreferrer" className="text-yellow-600 hover:text-yellow-700">
              Documentation de sécurité Stripe
            </a>
          </li>
          <li>
            <a href="https://www.airtel.africa/money" target="_blank" rel="noopener noreferrer" className="text-yellow-600 hover:text-yellow-700">
              Airtel Money
            </a>
          </li>
        </ul>
